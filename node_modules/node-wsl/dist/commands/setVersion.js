 ...
 */
exports.setVersion = function (distribution, version, options) { return __awaiter(void 0, void 0, void 0, function () {
    var commandArgs;
    return __generator(this, function (_a) {
        ow_1.default(distribution, 'distribution', ow_1.default.string.not.empty);
        ow_1.default(version, 'version', ow_1.default.number.oneOf([1, 2]));
        ow_1.default(options, 'options', ow_1.default.optional.object);
        commandArgs = ['--set-version', distribution, version.toString()];
